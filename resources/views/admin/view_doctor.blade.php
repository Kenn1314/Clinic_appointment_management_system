...
<table class="table table-striped table-hover dt-responsive nowrap" id="doctor_table" style="width:100%">
    ...
    <tbody class="table-info">
        @foreach($doctors as $key => $doctor)
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target='#deleteModal_{{$doctor->id}}'>
                        DELETE
                    </button>

                    <!-- APPROVED MODAL DISPLAY -->
                    @include('partials.prompt_window', [
                    'modal_id' => 'deleteModal_'.$doctor->id,
