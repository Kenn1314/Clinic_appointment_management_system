...
<div class="d-flex justify-content-center align-items-center" style="height: 75vh;">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-dark text-white" style="text-align: center; font-size: 25x; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif"> {{ isset($url) ? ucwords($url) : ""}}
                        {{ __('Login') }}
                    </div>
                    ...
                    <div class="card-body" style="background-color: #abcdef">
                        ...
                        <form method="POST" action='{{ url("login/$url") }}' arialabel="{{ __('Login') }}">
                            ...
                            <form method="POST" action="{{ route('login') }}" arialabel="{{ __('Login') }}">
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-4 col-formlabel text-md-right">{{ __('Password')
                                        }}</label>
                                    <div class="col-md-6">
